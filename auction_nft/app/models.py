...
class Profile(models.Model):
    ...
    address_g = models.CharField(max_length=256, blank=False,null=False,unique=True,error_messages={'unique': 'This address is already registered'})
...
class Artwork(models.Model):
    ...
    artwork_uri = models.CharField(max_length=5000)
    item_hash = models.CharField(max_length=256, blank=True, null=False)
